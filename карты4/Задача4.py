...
class MainWindow(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.map_l = 'map'
        self.map_key = ''
        self.sputnik.clicked.connect(self.press_func2)
        self.Cxema.clicked.connect(self.press_func1)
        self.gibrid.clicked.connect(self.press_func3)
        self.refresh_map()


    def press_func1(self):
        self.map_l = "map"
        self.refresh_map()


    def press_func2(self):
        self.map_l = "sat"
        self.refresh_map()


    def press_func3(self):
        self.map_l = "sat, map"
        self.refresh_map()
    ...
    def refresh_map(self):
        ...
        response = session.get('https://static-maps.yandex.ru/1.x/',
                                params=map_params)
        with open('../../Downloads/tmp.png', mode='wb') as tmp:
